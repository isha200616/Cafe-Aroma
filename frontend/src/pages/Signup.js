...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      ...
      >
        <h2 className="text-3xl font-bold text-center mb-6 text-amber-600">Create Account</h2>
        ...
        <p className="text-center mt-4 text-gray-600 dark:text-gray-400">
          Already have an account? <Link to="/login" className="text-amber-600 font-bold hover:underline">Login</Link>
        </p>
      </motion.div>
    </div>
  );
